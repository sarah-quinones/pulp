...
impl Avx512dq {
	delegate!({
		...
		fn _kortest_mask8_u8(a: __mmask8, b: __mmask8, all_ones: *mut u8) -> u8;
		...
		fn _ktest_mask16_u8(a: __mmask16, b: __mmask16, and_not: *mut u8) -> u8;
		fn _ktest_mask8_u8(a: __mmask8, b: __mmask8, and_not: *mut u8) -> u8;
		...
		fn _load_mask8(mem_addr: *const __mmask8) -> __mmask8;
		fn _store_mask8(mem_addr: *mut __mmask8, a: __mmask8);
