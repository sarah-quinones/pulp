...
impl Avx512dq {
	delegate!(
		#[target_feature(enable = "avx512vl,avx512dq")]
		{
			...
			fn _mm512_maskz_extracti32x8_epi32<const IMM8: i32>(k: __mmask8, a: __m512i)
			-> __m256i;
			...
			fn _mm256_maskz_extracti64x2_epi64<const IMM8: i32>(k: __mmask8, a: __m256i)
			-> __m128i;
			...
			fn _mm512_maskz_extracti64x2_epi64<const IMM8: i32>(k: __mmask8, a: __m512i)
			-> __m128i;
			...
			fn _mm512_maskz_insertf32x8<const IMM8: i32>(
				k: __mmask16,
				a: __m512,
				b: __m256,
			) -> __m512;
			...
			fn _mm512_maskz_cvt_roundepi64_pd<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512i,
			) -> __m512d;
			...
			fn _mm512_maskz_cvt_roundepi64_ps<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512i,
			) -> __m256;
			...
			fn _mm512_maskz_cvt_roundepu64_pd<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512i,
			) -> __m512d;
			...
			fn _mm512_maskz_cvt_roundepu64_ps<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512i,
			) -> __m256;
			...
			fn _mm512_maskz_cvt_roundpd_epi64<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512d,
			) -> __m512i;
			...
			fn _mm512_maskz_cvt_roundps_epi64<const ROUNDING: i32>(
				k: __mmask8,
				a: __m256,
			) -> __m512i;
			...
			fn _mm512_maskz_cvt_roundpd_epu64<const ROUNDING: i32>(
				k: __mmask8,
				a: __m512d,
			) -> __m512i;
			...
			fn _mm512_maskz_cvt_roundps_epu64<const ROUNDING: i32>(
				k: __mmask8,
				a: __m256,
			) -> __m512i;
			...
			fn _mm256_maskz_range_pd<const IMM8: i32>(
				k: __mmask8,
				a: __m256d,
				b: __m256d,
			) -> __m256d;
			...
			fn _mm512_maskz_range_pd<const IMM8: i32>(
				k: __mmask8,
				a: __m512d,
				b: __m512d,
			) -> __m512d;
			fn _mm512_range_round_ps<const IMM8: i32, const SAE: i32>(
				a: __m512,
				b: __m512,
			) -> __m512;
			...
			fn _mm512_maskz_range_ps<const IMM8: i32>(k: __mmask16, a: __m512, b: __m512)
			-> __m512;
			fn _mm_range_round_sd<const IMM8: i32, const SAE: i32>(
				a: __m128d,
				b: __m128d,
			) -> __m128d;
			...
			fn _mm_mask_reduce_pd<const IMM8: i32>(
				src: __m128d,
				k: __mmask8,
				a: __m128d,
			) -> __m128d;
			...
			fn _mm256_mask_reduce_pd<const IMM8: i32>(
				src: __m256d,
				k: __mmask8,
				a: __m256d,
			) -> __m256d;
			...
			fn _mm512_mask_reduce_pd<const IMM8: i32>(
				src: __m512d,
				k: __mmask8,
				a: __m512d,
			) -> __m512d;
			...
			fn _mm256_mask_reduce_ps<const IMM8: i32>(
				src: __m256,
				k: __mmask8,
				a: __m256,
			) -> __m256;
			...
			fn _mm512_mask_reduce_ps<const IMM8: i32>(
				src: __m512,
				k: __mmask16,
				a: __m512,
			) -> __m512;
			fn _mm512_maskz_reduce_ps<const IMM8: i32>(k: __mmask16, a: __m512) -> __m512;
			fn _mm_reduce_round_sd<const IMM8: i32, const SAE: i32>(
				a: __m128d,
				b: __m128d,
			) -> __m128d;
			...
			fn _mm_maskz_reduce_sd<const IMM8: i32>(k: __mmask8, a: __m128d, b: __m128d)
			-> __m128d;
			fn _mm_reduce_round_ss<const IMM8: i32, const SAE: i32>(a: __m128, b: __m128)
			-> __m128;
