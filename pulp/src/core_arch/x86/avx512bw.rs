...
impl Avx512bw {
	delegate!(
		#[target_feature(enable = "avx512vl,avx512bw")]
		{
			...
			fn _mm512_mask_add_epi16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_adds_epu8(src: __m512i, k: __mmask64, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_adds_epi8(src: __m512i, k: __mmask64, a: __m512i, b: __m512i)
			-> __m512i;
			fn _mm512_maskz_adds_epi8(k: __mmask64, a: __m512i, b: __m512i) -> __m512i;
			fn _mm512_sub_epi16(a: __m512i, b: __m512i) -> __m512i;
			fn _mm512_mask_sub_epi16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_subs_epu8(src: __m512i, k: __mmask64, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_subs_epi8(src: __m512i, k: __mmask64, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_max_epu16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_max_epi16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_min_epu16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_min_epi16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_avg_epu16(src: __m512i, k: __mmask32, a: __m512i, b: __m512i)
			-> __m512i;
			...
			unsafe fn _mm512_mask_cvtsepi16_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask32,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtepi16_storeu_epi8(mem_addr: *mut i8, k: __mmask32, a: __m512i);
			unsafe fn _mm512_mask_cvtusepi16_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask32,
				a: __m512i,
			);
			...
			fn _mm256_mask_add_epi16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_adds_epu8(src: __m256i, k: __mmask32, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_adds_epi8(src: __m256i, k: __mmask32, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_sub_epi16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_subs_epu8(src: __m256i, k: __mmask32, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_subs_epi8(src: __m256i, k: __mmask32, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_max_epu16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_max_epi16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_min_epu16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_min_epi16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_reduce_add_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_add_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_add_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_add_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_add_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_add_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_add_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_add_epi8(k: __mmask16, a: __m128i) -> i8;
			fn _mm256_reduce_and_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_and_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_and_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_and_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_and_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_and_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_and_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_and_epi8(k: __mmask16, a: __m128i) -> i8;
			fn _mm256_reduce_max_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_max_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_max_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_max_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_max_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_max_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_max_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_max_epi8(k: __mmask16, a: __m128i) -> i8;
			fn _mm256_reduce_max_epu16(a: __m256i) -> u16;
			fn _mm256_mask_reduce_max_epu16(k: __mmask16, a: __m256i) -> u16;
			fn _mm_reduce_max_epu16(a: __m128i) -> u16;
			fn _mm_mask_reduce_max_epu16(k: __mmask8, a: __m128i) -> u16;
			fn _mm256_reduce_max_epu8(a: __m256i) -> u8;
			fn _mm256_mask_reduce_max_epu8(k: __mmask32, a: __m256i) -> u8;
			fn _mm_reduce_max_epu8(a: __m128i) -> u8;
			fn _mm_mask_reduce_max_epu8(k: __mmask16, a: __m128i) -> u8;
			fn _mm256_reduce_min_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_min_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_min_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_min_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_min_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_min_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_min_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_min_epi8(k: __mmask16, a: __m128i) -> i8;
			fn _mm256_reduce_min_epu16(a: __m256i) -> u16;
			fn _mm256_mask_reduce_min_epu16(k: __mmask16, a: __m256i) -> u16;
			fn _mm_reduce_min_epu16(a: __m128i) -> u16;
			fn _mm_mask_reduce_min_epu16(k: __mmask8, a: __m128i) -> u16;
			fn _mm256_reduce_min_epu8(a: __m256i) -> u8;
			fn _mm256_mask_reduce_min_epu8(k: __mmask32, a: __m256i) -> u8;
			fn _mm_reduce_min_epu8(a: __m128i) -> u8;
			fn _mm_mask_reduce_min_epu8(k: __mmask16, a: __m128i) -> u8;
			fn _mm256_reduce_mul_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_mul_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_mul_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_mul_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_mul_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_mul_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_mul_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_mul_epi8(k: __mmask16, a: __m128i) -> i8;
			fn _mm256_reduce_or_epi16(a: __m256i) -> i16;
			fn _mm256_mask_reduce_or_epi16(k: __mmask16, a: __m256i) -> i16;
			fn _mm_reduce_or_epi16(a: __m128i) -> i16;
			fn _mm_mask_reduce_or_epi16(k: __mmask8, a: __m128i) -> i16;
			fn _mm256_reduce_or_epi8(a: __m256i) -> i8;
			fn _mm256_mask_reduce_or_epi8(k: __mmask32, a: __m256i) -> i8;
			fn _mm_reduce_or_epi8(a: __m128i) -> i8;
			fn _mm_mask_reduce_or_epi8(k: __mmask16, a: __m128i) -> i8;
			...
			fn _mm256_mask_madd_epi16(src: __m256i, k: __mmask8, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm_mask_maddubs_epi16(src: __m128i, k: __mmask8, a: __m128i, b: __m128i)
			-> __m128i;
			...
			fn _mm_mask_packus_epi16(src: __m128i, k: __mmask16, a: __m128i, b: __m128i)
			-> __m128i;
			fn _mm_maskz_packus_epi16(k: __mmask16, a: __m128i, b: __m128i) -> __m128i;
			fn _mm256_mask_avg_epu16(src: __m256i, k: __mmask16, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm_mask_sll_epi16(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_srl_epi16(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_sra_epi16(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_shuffle_epi8(src: __m128i, k: __mmask16, a: __m128i, b: __m128i)
			-> __m128i;
			...
			unsafe fn _mm256_mask_cvtsepi16_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask16,
				a: __m256i,
			);
			...
			unsafe fn _mm256_mask_cvtusepi16_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask16,
				a: __m256i,
			);
