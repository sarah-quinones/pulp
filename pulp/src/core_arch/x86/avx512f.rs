...
impl Avx512f {
	delegate!(
		#[target_feature(enable = "avx512vl,avx512f")]
		{
			...
			fn _mm512_mask_add_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_sub_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_max_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_max_epu32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_min_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_min_epu32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_maskz_fmaddsub_pd(k: __mmask8, a: __m512d, b: __m512d, c: __m512d)
			-> __m512d;
			fn _mm512_mask3_fmaddsub_pd(a: __m512d, b: __m512d, c: __m512d, k: __mmask8)
			-> __m512d;
			...
			fn _mm512_maskz_fmsubadd_pd(k: __mmask8, a: __m512d, b: __m512d, c: __m512d)
			-> __m512d;
			fn _mm512_mask3_fmsubadd_pd(a: __m512d, b: __m512d, c: __m512d, k: __mmask8)
			-> __m512d;
			...
			unsafe fn _mm512_mask_compressstoreu_epi32(
				base_addr: *mut i32,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_compressstoreu_epi64(
				base_addr: *mut i64,
				k: __mmask8,
				a: __m512i,
			);
			...
			fn _mm512_mask_rolv_epi64(src: __m512i, k: __mmask8, a: __m512i, b: __m512i)
			-> __m512i;
			fn _mm512_maskz_rolv_epi64(k: __mmask8, a: __m512i, b: __m512i) -> __m512i;
			fn _mm512_rorv_epi64(a: __m512i, b: __m512i) -> __m512i;
			fn _mm512_mask_rorv_epi64(src: __m512i, k: __mmask8, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_maskz_extracti64x4_epi64<const IMM1: i32>(k: __mmask8, a: __m512i)
			-> __m256i;
			...
			fn _mm512_maskz_extracti32x4_epi32<const IMM2: i32>(k: __mmask8, a: __m512i)
			-> __m128i;
			...
			fn _mm256_maskz_extracti32x4_epi32<const IMM1: i32>(k: __mmask8, a: __m256i)
			-> __m128i;
			...
			fn _mm512_mask_and_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			fn _mm512_mask_xor_epi32(src: __m512i, k: __mmask16, a: __m512i, b: __m512i)
			-> __m512i;
			...
			unsafe fn _mm512_mask_cvtepi32_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtsepi32_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtusepi32_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtepi32_storeu_epi8(mem_addr: *mut i8, k: __mmask16, a: __m512i);
			unsafe fn _mm512_mask_cvtsepi32_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtusepi32_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask16,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtepi64_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask8,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtsepi64_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask8,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtusepi64_storeu_epi16(
				mem_addr: *mut i16,
				k: __mmask8,
				a: __m512i,
			);
			...
			unsafe fn _mm512_mask_cvtusepi64_storeu_epi8(
				mem_addr: *mut i8,
				k: __mmask8,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtepi64_storeu_epi32(
				mem_addr: *mut i32,
				k: __mmask8,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtsepi64_storeu_epi32(
				mem_addr: *mut i32,
				k: __mmask8,
				a: __m512i,
			);
			unsafe fn _mm512_mask_cvtusepi64_storeu_epi32(
				mem_addr: *mut i32,
				k: __mmask8,
				a: __m512i,
			);
			...
			unsafe fn _mm_mask_loadu_pd(src: __m128d, k: __mmask8, mem_addr: *const f64)
			-> __m128d;
			...
			unsafe fn _mm512_maskz_expandloadu_epi32(k: __mmask16, mem_addr: *const i32)
			-> __m512i;
			...
			unsafe fn _mm_mask_expandloadu_ps(
				src: __m128,
				k: __mmask8,
				mem_addr: *const f32,
			) -> __m128;
			...
			fn _mm256_maskz_fmaddsub_pd(k: __mmask8, a: __m256d, b: __m256d, c: __m256d)
			-> __m256d;
			fn _mm256_mask3_fmaddsub_pd(a: __m256d, b: __m256d, c: __m256d, k: __mmask8)
			-> __m256d;
			...
			fn _mm256_maskz_fmsubadd_pd(k: __mmask8, a: __m256d, b: __m256d, c: __m256d)
			-> __m256d;
			fn _mm256_mask3_fmsubadd_pd(a: __m256d, b: __m256d, c: __m256d, k: __mmask8)
			-> __m256d;
			...
			unsafe fn _mm256_mask_compressstoreu_epi32(
				base_addr: *mut i32,
				k: __mmask8,
				a: __m256i,
			);
			unsafe fn _mm_mask_compressstoreu_epi32(base_addr: *mut i32, k: __mmask8, a: __m128i);
			unsafe fn _mm256_mask_compressstoreu_epi64(
				base_addr: *mut i64,
				k: __mmask8,
				a: __m256i,
			);
			...
			fn _mm_mask_sll_epi32(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_srl_epi32(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_sll_epi64(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_srl_epi64(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_sra_epi32(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm_mask_sra_epi64(src: __m128i, k: __mmask8, a: __m128i, count: __m128i)
			-> __m128i;
			...
			fn _mm256_mask_rolv_epi32(src: __m256i, k: __mmask8, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_rorv_epi32(src: __m256i, k: __mmask8, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_rolv_epi64(src: __m256i, k: __mmask8, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_rorv_epi64(src: __m256i, k: __mmask8, a: __m256i, b: __m256i)
			-> __m256i;
			...
			fn _mm256_mask_permutevar_ps(src: __m256, k: __mmask8, a: __m256, b: __m256i)
			-> __m256;
			...
			fn _mm_mask_permutevar_pd(src: __m128d, k: __mmask8, a: __m128d, b: __m128i)
			-> __m128d;
			...
			fn _mm_maskz_permutex2var_ps(k: __mmask8, a: __m128, idx: __m128i, b: __m128)
			-> __m128;
			fn _mm_mask2_permutex2var_ps(a: __m128, idx: __m128i, k: __mmask8, b: __m128)
			-> __m128;
